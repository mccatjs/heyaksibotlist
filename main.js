...
mongoose.connect(url, {//https://www.itemsatis.com/profil/377973/furylemons.html
...
let cmd
if (client.komutlar.has(command)) {//https://www.itemsatis.com/profil/377973/furylemons.html
...
client.on('guildMemberRemove', async member => {
  const botlar = require('./models/botlist/bots.js')
  let data = await botlar.findOne({ ownerID: member.id })//https://www.itemsatis.com/profil/377973/furylemons.html
  if(!data) return
